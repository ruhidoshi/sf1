def look_disk_scheduling(requests, head_start, direction="left"):
    ...
    while requests_copy:
        ...
        # If there are remaining requests and the direction is left, change direction
        if requests_copy and direction == "left":
            direction = "right"
            continue

        # If there are remaining requests and the direction is right, change direction
        if requests_copy and direction == "right":
            direction = "left"
            continue
...
if __name__ == "__main__":
    ...
    # Call the look_disk_scheduling function with the specified requests, head position, and direction
    total_movement = look_disk_scheduling(requests, initial_head_position, direction="left")
